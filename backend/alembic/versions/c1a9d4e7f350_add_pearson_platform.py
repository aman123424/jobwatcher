"""add pearson platform

Revision ID: c1a9d4e7f350
Revises: b8e6f3a2d719
...
revision: str = 'c1a9d4e7f350'
down_revision: Union[str, Sequence[str], None] = 'b8e6f3a2d719'
...
def upgrade() -> None:
    """
    Adds 'pearson' to the existing `platform` Postgres ENUM type
    ...
    with op.get_context().autocommit_block():
        op.execute("ALTER TYPE platform ADD VALUE 'pearson'")
